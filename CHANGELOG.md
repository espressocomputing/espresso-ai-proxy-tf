...
- Report version info as OTEL attributes via derived env vars: `service_version`
  (`SERVICE_VERSION`, from `proxy_image`) and `tf_version` (`TF_VERSION`, from the module's
